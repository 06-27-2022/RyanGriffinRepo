public class PrimitiveDataType{
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * boolean (negligible bit value) - represent value of either true or false
		 * char (2 bit values) - represents a single character
		 * byte (8 bit values) - represents a value between -128 and 127
		...
		//assignments based on whether or not
